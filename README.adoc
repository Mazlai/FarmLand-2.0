...
Du côté de l'interface Angular, les erreurs envoyées du backend sont attrapées et des messages sont affichés en conséquence afin d'informer plus convenablement l'utilisateur.

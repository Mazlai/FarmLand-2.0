...
// TODO: screenshots exemple traces erreurs avec stack complète -> Afficher date + stack erreur dans fichier log
...
// TODO: screenshot exemple traces erreurs prod avec messages classiques

...
export const getAllAnimalTypesAsync = async (
  _req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const getAnimalStockByIdAsync = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const getCurrentUserAnimalStocksAsync = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const addAnimalStockAsync = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
    const animal = req.body as {
      description: string;
      animalTypeId: number;
      count: number;
    };
...
export const updateAnimalStockAsync = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const deleteAnimalStockAsync = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
 ...
 */
async function getUserIdFromReqAsync(
  req: Request,
  res: Response,
